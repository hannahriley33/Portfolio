export const projects = [
  {
    ...
    projectImage: '../src/assets/alchimiaImage.png',
    ...
    summary: 'A game based off of the existing tile-board game, Carcasonne. Users can build their mighty kingdom and strive for high scores. I enjoyed developing the initial board tile placement, and implementing scoring.'
  },
  {    
    projectTitle: 'Social Distance-Ping',
    projectImage: '../src/assets/Ping.png',
    projectGit: 'https://github.com/Alchemy-Covid-19/covid-19-statbot',
    projectStack: ['Node.js', 'MongoDB', 'Express', 'Heroku', 'Twilio'],
    summary: 'Users receive location-specific COVID-19 stats sent to their phones on demand or automatically each evening. Personal contributions include developing back-end models, routes, and testing using MongoDB and Express, and implementing Twilio technology.'
  },
  {
